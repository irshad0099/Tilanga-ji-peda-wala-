...
import { shop as defaultShop, upi as defaultUpi } from "@/lib/config";
 ...
 * Pass live { shop, upi } from useSettings() — falls back to lib/config.
 */
export async function downloadInvoicePdf(invoice, { shop = defaultShop, upi = defaultUpi } = {}) {
