...
export const shop = {
  ...
  // Stable "cid" link to the real Google Maps listing — used for the
  // "Read reviews on Google" button. Safe to reuse forever even if the
  // listing's name/address ever changes.
  googleMapsUrl: "https://www.google.com/maps?cid=16251555030627548466",
};

export const upi = {
  // Real UPI ID (VPA) payments land on. This is also stored live in the
  // MongoDB `settings` doc and editable from /admin — this value is only
  // the offline fallback / seed default.
  vpa: "vk7745349-1@okicici",
  payeeName: "Vishal Kumar",
